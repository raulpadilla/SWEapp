CKEDITOR.plugins.add( 'contentruleblock',
{
   ...
   init : function( editor )
   {
	   ...
	   var g_arrRule        =  window.g_arrRule;   
	   var g_arrOperator    =  window.g_arrOperator;
	   var g_arrOperatorMap =  window.g_arrOperatorMap;
	   var g_iMergeField    =  window.g_iMergeField;
