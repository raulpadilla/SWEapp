...
function Account_BusComp (busComp)
{
   if (busComp != null)
   {
...
new Account_BusComp (null);

Account_BusComp.prototype = new top.JSSBusCompShadow ();

Account_BusComp.prototype.OnPreSetFieldValue = Account_BusComp_PreSetFieldValue;
