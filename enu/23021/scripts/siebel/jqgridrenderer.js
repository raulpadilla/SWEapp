...
if ( typeof ( SiebelAppFacade.JQGridRenderer ) === "undefined" ) {
    ...
    SiebelAppFacade.JQGridRenderer = ( function() {
      ...
      function JQGridRenderer( proxy ) {
        ...
        this.GetPM().AttachPMBinding( "NavigateState", PreUpdateNavigateInfo, { scope : this } );
 ...
 *  */
      ...
      JQGridRenderer.prototype.ShowUI = function( ) {
          ...
          var pm            = this.GetPM(),
              ...
              columnInfo    = PrepareColumnInfo.call( this, pm.Get( "ListOfColumns" )  );
          ...
          if(jqGridCtrl.length>0){
              ...
              //TODO: : Will update below if condition when we standardize the shuttle.
      ...
      JQGridRenderer.prototype.BindEvents = function( controlSet ) {
        ...
        this.GetGrid().jqGrid( "setGridParam", {
          ...
          afterEditCell : function( rowid, cellname, value, iRow, iCol )
          {
              ...
              if( controlType === combo ){
                  ctrlEl
                      ...
                      // Bug#16385076
                      .bind( "autocompleteselect", { ctx : that, ctrl : control }, function ( evt, ui){
                       ...
                       .bind( "autocompleteopen", { ctx : that, ctrl : control }, function ( evt){
                          evt.data.ctx.GetPM().SetProperty ( "isControlPopupOpen", true );
                      })
                      .bind( "autocompleteclose", { ctx : that, ctrl : control }, function ( evt){
          ...
          beforeSaveCell : function( rowid, cellname, value, iRow, iCol ) {
            ...
            if( ctrl ){
                if( ctrl.GetUIType() === combo ){ // Bug#16385076
                    value = FormatDDInQueryMode.call( that, ctrl, value );
                }
                 ...
                 */
                value = that.GetGrid().find( "#" + iRow + "_" + cellname  ).val();
            }
            if ( iCol === 0 && that.GetPM().Get("HasHierarchy") ) {
                iRow = Number( iRow );
                that.GetGrid().jqGrid( "setTreeNode", iRow, iRow + 1 );
            }
            if (that.GetPM().Get("IsInQueryMode") && ctrl.GetCaseSensitive() && value === "") {
          ...
          afterRestoreCell : function( rowid, value, iRow, iCol ) {
            ...
            if (that.GetPM().Get("IsInQueryMode") && ctrl.GetCaseSensitive() && (value === localeObj.GetLocalString("IDS_SWE_CSQ_WATERMARK"))) {
              value = "";
            }
