if( typeof( SiebelAppFacade.RecycleBinRenderer ) === "undefined" ){
    ...
    SiebelApp.S_App.RegisterConstructorAgainstKey( "RecycleListRenderer", "SiebelAppFacade.RecycleBinRenderer" );
