function Chep_OrgLoc_List_Applet__MM_Child_Reporting_Applet_PreInvokeMethod (name, inputPropSet)
{
...
function Chep_OrgLoc_List_Applet__MM_Child_Reporting_Applet (applet)
{
   if (applet != null)
   {
      this._applet = applet;
...
new Chep_OrgLoc_List_Applet__MM_Child_Reporting_Applet (null);

Chep_OrgLoc_List_Applet__MM_Child_Reporting_Applet.prototype = new top.JSSAppletShadow ();

Chep_OrgLoc_List_Applet__MM_Child_Reporting_Applet.prototype.OnPreInvokeMethod = Chep_OrgLoc_List_Applet__MM_Child_Reporting_Applet_PreInvokeMethod;
