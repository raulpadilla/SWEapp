...
$.extend(Calculator.prototype, {
	...
	_connectCalculator: function(target, inst) {
		...
		if (!inst._inline){
		    inst._mainDiv.keydown(this._doKeyDown).keyup(this._doKeyUp).keypress(this._doKeyPress);
		}
		if (inst._inline) {
		    inst._input.keydown(this._doKeyDown).keyup(this._doKeyUp).keypress(this._doKeyPress);
	...
	_destroyCalculator: function(target) {
		...
		inst._mainDiv.unbind('keydown', this._doKeyDown).
			unbind('keyup', this._doKeyUp).
			unbind('keypress', this._doKeyPress);
	...
	_showCalculator: function(input) {
		...
		inst._mainDiv.attr("aria-label",this._get(inst, 'popupTitle'))
