...
//			this.load( options.active );
	...
	_processTabs: function() {
		...
		this.anchors.not( this.active || 0 ).each(function( i, a ) {
			var selector, panel;
	...
	_destroy: function() {
		...
		$.cleanData( this.panels );
		
		/* Removing References. Since we keep on destroying tab and recreating them */
		this.lis = this.anchors = this.panels = this.active = this.list = null;
