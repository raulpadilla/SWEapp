function CHEP_AIM_OrgLoc_List_Applet_Applet_PreInvokeMethod (name, inputPropSet)
{
...
function CHEP_AIM_OrgLoc_List_Applet_Applet (applet)
{
   if (applet != null)
   {
      this._applet = applet;
...
new CHEP_AIM_OrgLoc_List_Applet_Applet (null);

CHEP_AIM_OrgLoc_List_Applet_Applet.prototype = new top.JSSAppletShadow ();

CHEP_AIM_OrgLoc_List_Applet_Applet.prototype.OnPreInvokeMethod = CHEP_AIM_OrgLoc_List_Applet_Applet_PreInvokeMethod;
