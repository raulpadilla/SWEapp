...
$.extend($.jgrid,{
	...
	formatter : {
		...
		date : {
			dayNames:   [
                 _SWEgetMessage("IDS_SWE_JQGRID_DAY_SHORT_SUN"), _SWEgetMessage("IDS_SWE_JQGRID_DAY_SHORT_MON"), _SWEgetMessage("IDS_SWE_JQGRID_DAY_SHORT_TUE"), _SWEgetMessage("IDS_SWE_JQGRID_DAY_SHORT_WED"), _SWEgetMessage("IDS_SWE_JQGRID_DAY_SHORT_THU"), _SWEgetMessage("IDS_SWE_JQGRID_DAY_SHORT_FRI"), _SWEgetMessage("IDS_SWE_JQGRID_DAY_SHORT_SAT"),
