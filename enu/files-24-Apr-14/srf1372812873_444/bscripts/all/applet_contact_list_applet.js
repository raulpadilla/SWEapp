function Contact_List_Applet_Applet_PreInvokeMethod (name, inputPropSet)
{
/*--------------------------------------------------------------------
...
if(name == "Drilldown")
	{
		...
		if(sControlId == "s_1_2_83") //Note: Any change to the position of Email Address in weblayout should be considered as it would have impact to the below code.
		{		
...
function Contact_List_Applet_Applet (applet)
{
   if (applet != null)
   {
      this._applet = applet;
...
new Contact_List_Applet_Applet (null);

Contact_List_Applet_Applet.prototype = new top.JSSAppletShadow ();

Contact_List_Applet_Applet.prototype.OnPreInvokeMethod = Contact_List_Applet_Applet_PreInvokeMethod;
