...
function SIInvokeMethod__sweview (methodName, swecount)
{
   ...
   else
   {
      ...
      var service  = top._swe._sweapp.S_App.GetService ("Task Assistant UI Service");
...
function TaskInvokeMethod_OpenPlayer (launchMethodName, taskId, swecount)
{
   ...
   {
      var inPropSet = top._swe._sweapp.S_App.NewPropertySet ();
      var outPropSet = null;
...
function TaskFastServiceInvokeMethod (methodName, inPropSet)
{
   ...
   else
   {
      ...
      if (TaskObj () != null)
      {
         ...
         var argsPropSet = top._swe._sweapp.S_App.NewPropertySet ();
         ...
         // process outPropSet
         outPropSet = top._swe._sweapp.S_App.NewPropertySet ();
...
{
   var inPropSet = top._swe._sweapp.S_App.NewPropertySet ();
   var inPropSet1 = top._swe._sweapp.S_App.NewPropertySet ();
   inPropSet.SetProperty("TaskName", taskName);
   service  = top._swe._sweapp.S_App.GetService ("Task UI Service (SWE)");
