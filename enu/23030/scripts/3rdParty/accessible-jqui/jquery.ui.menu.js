...
$.widget( "ui.menu", {
	...
	_move: function( direction, filter, event ) {
		...
		if ( direction === "first" || direction === "last" ) {
			next = this.active[ direction === "first" ? "prevAll" : "nextAll" ]( ".ui-menu-item" ).not( function(){
			    return $( this ).children( "a.ui-state-disabled" ).length > 0; 
			}).eq( -1 );
		} else {
			next = this.active[ direction + "All" ]( ".ui-menu-item" ).not( function(){
                return $( this ).children( "a.ui-state-disabled" ).length > 0; 
            }).eq( 0 );
		}
