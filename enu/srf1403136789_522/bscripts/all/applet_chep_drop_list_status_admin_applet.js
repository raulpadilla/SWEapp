function Chep_Drop_List_Status_Admin_Applet_Applet_PreInvokeMethod (name, inputPropSet)
...
if (name=="Delete_DropList")
	{	        
	        if(confirm("This action will delete Drop List "+this.BusComp().GetFieldValue("Name")+" along with all its lines and cannot be recovered.  Are you sure you want to delete this Drop List?"))
...
function Chep_Drop_List_Status_Admin_Applet_Applet (applet)
{
   if (applet != null)
   {
      this._applet = applet;
...
new Chep_Drop_List_Status_Admin_Applet_Applet (null);

Chep_Drop_List_Status_Admin_Applet_Applet.prototype = new top.JSSAppletShadow ();

Chep_Drop_List_Status_Admin_Applet_Applet.prototype.OnPreInvokeMethod = Chep_Drop_List_Status_Admin_Applet_Applet_PreInvokeMethod;
