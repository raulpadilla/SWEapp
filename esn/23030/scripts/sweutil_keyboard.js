...
function SetCurrentAppletIndex(index) 
{
   ...
   if (index != null)
   {
      ...
      // set new active
   //Bug#12755595: No need to check this condition for all applets because, some of applets does not have the 
 // highlightinfo to show applet is been selected or not. For example, tree applets does not have the highlightinfo.
// Hence here setting active for highLightInfo only if the applet has highLightInfo
      if (SWEApplets[index] != null && typeof SWEApplets[index] != "undefined" ) 
      {
         if ( SWEApplets[index].highLightInfo != null && typeof SWEApplets[index].highLightInfo != "undefined")
        {
