function Account_Quick_Search_BusComp_PreSetFieldValue (fieldName, value)
{
...
function Account_Quick_Search_BusComp (busComp)
{
   if (busComp != null)
   {
...
new Account_Quick_Search_BusComp (null);

Account_Quick_Search_BusComp.prototype = new top.JSSBusCompShadow ();

Account_Quick_Search_BusComp.prototype.OnPreSetFieldValue = Account_Quick_Search_BusComp_PreSetFieldValue;
